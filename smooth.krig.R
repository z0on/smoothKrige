...
#  latlon=ll;dset=dataset;V="NOX.B_range";variogram_model=variogram_model;polygon=keys.polygon;grid.res=1000;smooth.range=10;utm.zone=17;verbose=TRUE
  require(spatstat)
  require(automap)
  require(sp)
  require(sf)
  ...
  smoothed <- Smooth(pp, sigma = smooth.range)
